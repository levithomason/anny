...
describe('ACTIVATION', () => {
  ...
  it('has object values with a `func` method', () => {
    _.each(ACTIVATION, val => val.func.should.be.a('function'));
  });

  it('has object values with a `prime` method', () => {
    _.each(ACTIVATION, val => val.prime.should.be.a('function'));
  });

  it('has `func` and `prime` methods return numbers', () => {
    _.each(ACTIVATION, val => {
